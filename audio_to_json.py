...
def audio_to_json(audio_path, json_path):
    ...
    bar_act = RNNBarProcessor()((audio_path, beats))
...
if __name__ == '__main__':
    if len(sys.argv) != 3:
        print('Usage: audio_to_json.py path_to_audio_file path_to_output_file')
        exit(0)

    audio_to_json(sys.argv[1], sys.argv[2])